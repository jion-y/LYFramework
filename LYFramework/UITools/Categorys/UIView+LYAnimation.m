...
float radiansForDegrees(int degrees) { return degrees * M_PI / 180; }
 ...
 * 第一个参数定义动画类型，第二个参数是当前视图对象，第三个参数是是否使用缓冲区
...
- (void)animationRotateAndScaleEffects
{
    [UIView animateWithDuration:0.35f
        animations:^{
             ...
             *     animation.toValue = [NSValue valueWithCATransform3D:CATransform3DMakeRotation(M_PI, 0.50, -0.50,
             * 0.50)];
             *
